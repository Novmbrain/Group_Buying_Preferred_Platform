 ...
 * @description: Swagger configuration for admin and web api documentation.
 * Path selectors for admin is /admin/.* and for web is /api/.*
 * @author: Wenjie FU
 * @date: 14/01/2024
 **/
...
public class Swagger2Config {
  ...
  public Docket adminApiConfig() {
    ...
    Docket adminApi = new Docket(DocumentationType.SWAGGER_2)
      ...
      .select()
      // 只显示admin路径下的页面
      .apis(RequestHandlerSelectors.basePackage("com.wenjie.ssyx"))
